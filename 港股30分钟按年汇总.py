...
SOURCE_DIR = "/media/sky/Data/stock/港股_分时数据/30分钟_按月归档"
OUTPUT_DIR = "/media/sky/Data/stock/港股_分时数据/30分钟_按年汇总_tmp"
FINAL_DIR = "/media/sky/Data/stock/港股_分时数据/30分钟_按年汇总"

FILENAME_PATTERN = re.compile(r"(\d{8})_30min\.zip")
CHUNK_SIZE = 50_000
ENCODING = "utf-8-sig"
CLEAN_TMP = True
...
def pack_by_year():
    ...
    for year in tqdm(os.listdir(OUTPUT_DIR), desc="年度打包", unit="year"):
        ...
        zip_path = os.path.join(FINAL_DIR, f"{year}_30min.zip")
